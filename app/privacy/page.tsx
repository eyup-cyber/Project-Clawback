        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none" style={{ fontFamily: 'var(--font-body)' }}>
            <Section title="Our Commitment to Privacy">
              <p>
                Scroungers Multimedia is committed to protecting your privacy. We collect only the
                minimum data necessary to operate the platform and never sell your personal
                information to third parties.
              </p>
            </Section>

            <Section title="Information We Collect">
              <h3 className="font-bold mt-4 mb-2" style={{ color: 'var(--foreground)' }}>
                Account Information
              </h3>
            ...
            <Section title="Data Storage and Security">
              <p>
                ...
                our database, which provides enterprise-grade security. Media files are stored on
                Cloudflare R2.
              </p>
            </Section>
            ...
            <Section title="Third-Party Services">
              ...
              <ul>
                ...
                <li>
                  <strong>Cloudflare:</strong> Content delivery and media storage
                </li>
                <li>
                  <strong>Ko-fi:</strong> Payment processing for donations (external link)
                </li>
              </ul>
              <p>
                Each of these services has their own privacy policy that governs their handling of
                data.
              </p>
            </Section>
            ...
            <Section title="Data Retention">
              <p>
                ...
                your account, we will remove your personal data within 30 days, though some content
            ...
            <Section title="Changes to This Policy">
              <p>
                ...
                communicated via email or platform notification. The &quot;last updated&quot; date
            ...
            <Section title="Contact Us">
              <p>
                For privacy-related questions or to exercise your rights, please contact us via our{' '}
