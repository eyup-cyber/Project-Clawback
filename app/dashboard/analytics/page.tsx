...
export default async function AnalyticsPage() {
  ...
  const { data: posts } = await supabase
    .from('posts')
    .select(
      'id, title, slug, status, view_count, unique_view_count, reaction_count, comment_count, published_at, content_type'
    )
  ...
  const viewsByDay =
    recentViews?.reduce((acc: Record<string, number>, view) => {
