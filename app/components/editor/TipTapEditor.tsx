...
export default function TipTapEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          'prose prose-invert max-w-none min-h-[200px] sm:min-h-[300px] lg:min-h-[400px] focus:outline-none p-4 sm:p-6',
    ...
    >
      ...
      >
        <div className="flex items-center gap-3 sm:gap-4">
          <span style={{ opacity: 0.6, fontFamily: 'var(--font-body)' }}>{wordCount} words</span>
