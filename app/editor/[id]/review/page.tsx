  ...
  const handleSubmitDecision = async () => {
    ...
    try {
      ...
      const { error: notifError } = await supabase.from('notifications').insert({
        ...
        message: decision === 'approve' ? `"${post?.title}" is now live on the site.` : notes,
        link:
          decision === 'approve' ? `/articles/${post?.id}` : `/dashboard/posts/${post?.id}/edit`,
      });
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <label
                ...
                style={{
                  borderColor:
                    decision === 'request_changes' ? 'var(--secondary)' : 'var(--border)',
                  ...
                  decision === 'approve'
                    ...
                    : decision === 'request_changes'
                      ...
                      : decision === 'reject'
                        ? 'var(--accent)'
                        : 'var(--border)',
                color: decision ? 'var(--background)' : 'var(--foreground)',
              }}
            >
