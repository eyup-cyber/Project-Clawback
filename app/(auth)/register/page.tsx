  ...
  return (
    ...
    >
      ...
      <p
        ...
        style={{ color: 'var(--foreground)', opacity: 0.6, fontSize: '0.875rem' }}
      >
        Join the Scroungers community
      </p>
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <button
          ...
          className="flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-medium transition-all duration-200 hover:bg-[var(--surface-elevated)] disabled:opacity-50 disabled:cursor-not-allowed"
          style={{
